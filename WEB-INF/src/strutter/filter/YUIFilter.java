 ...
 */
/*
 * <filter> <display-name>Yahoo Compressor Filter</display-name>
 * <filter-name>YUIFilter</filter-name>
 * <filter-class>strutter.filter.YUIFilter</filter-class> <init-param>
 * <param-name>preserve-semi</param-name> <param-value>true</param-value>
 * </init-param> </filter>
 * 
 * <filter-mapping> <filter-name>YUIFilter</filter-name>
...
public class YUIFilter implements Filter
{
	...
	private boolean preserveAllSemiColons = true; // Preserve unnecessary
												  // semicolons
