...
public class ConfigManuelAction extends FormlessPlainDispatchAction implements ConfigInterface
{
	private static Log log = LogFactory.getLog(ConfigManuelAction.class);

	Address customer = new Address();
	String  memo;

	public void config(ActionConfig struts) {
		struts.addForward("configauto_view.jsp");
	}
