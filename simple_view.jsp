...
<br>
Label: <div type="resource" id="eintext" class="info"/>
<br>
...
<table width="100%">
  ...
  <tr>
      ...
      <!-- <div type="error" id="firstname" class="error"/> -->
      </td>
  </tr>
  <tr>
      <td>Lastname</td>
      <td><INPUT type="text" name="customer.lastname" error="before"> <html:errors property="number" /></td>
  </tr>
  <tr>
      <td>Street</td>
      <td><INPUT type="text" name="customer.street" error="class"> <html:errors property="number" /></td>
  </tr>
  <tr>
      <td>City</td>
