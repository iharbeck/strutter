...
input[type=submit]{
background: #93C410 none repeat scroll 0 0;
border:1px solid;
border-color: #93C410 #669900 #669900 #93C410
}
...
border:1px solid;
border-color:silver #444444 #444444 silver
}
</style>
...
<table width="100%">
  ...
  <tr>
	  ...
	  <td rowspan=6 width="310" valign="top">
		...
		<tr><td><span type="resource" id="button.label" /></td></tr>
		</table>
