...
import strutter.optional.controller.BaseFilter;
...
public abstract class AbstractPageFilter extends BaseFilter//implements Filter
{
	...
	{
		if(!ActionHelper.hasAction(action))
			return false;

		try {
			ConfigWrapper config = ActionHelper.getAction(action);
