...
<div class=topheadermid>SAMPLE<a href="sample.do?action=preview"> preview</a>
...
<br>
<input border=0 type=button class="defaultbutton" onclick="subber('search')" value="Continue">
