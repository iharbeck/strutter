...
public class FormlessDispatchAction extends ExtDispatchAction 
{
			...
			throws Exception 
	{
		...
		populate(this, mapping.getPrefix(), mapping.getSuffix(), request);

		// Store Action (Form)
		Utils.setActionForm(request, this);

		// Get the parameter. This could be overridden in subclasses.
        String parameter = getParameter(mapping, actionform, request, response);

        // Get the method's name. This could be overridden in subclasses.
        String name = getMethodName(mapping, actionform, request, response, parameter);

        ActionForward forward = dispatchMethod(mapping, actionform, request, response, name);
