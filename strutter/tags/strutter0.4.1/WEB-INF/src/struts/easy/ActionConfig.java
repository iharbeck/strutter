...
public class ActionConfig 
{
	...
	public void addForward(String path, boolean redirect) {
		String name = path.substring(path.indexOf('_')+1, path.lastIndexOf('.'));
		addForward(new Forward(name.toLowerCase(), path, redirect));
	}
	...
	public void addGlobalForward(String path, boolean redirect) {
		String name = path.substring(path.indexOf('_')+1, path.lastIndexOf('.'));
		addForward(new Forward(name.toLowerCase(), path, redirect).setGlobal(true));
	}
