...
public class FormlessHelper 
{
	private static Log log = LogFactory.getLog(FormlessHelper.class);
	
	public static void populate(ActionMapping actionmapping, Object bean, String prefix, String suffix, HttpServletRequest request)
    	throws ServletException 
	{
		...
		if (bean instanceof FormlessInterface) {
		    ((FormlessInterface) bean).setMultipartRequestHandler(null);
		}
		...
		// Call reset
		((FormlessInterface)bean).reset(actionmapping, request);
