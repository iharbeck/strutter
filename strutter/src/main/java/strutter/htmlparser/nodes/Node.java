...
//
// $URL: https://htmlparser.svn.sourceforge.net/svnroot/htmlparser/trunk/lexer/src/main/java/org/htmlparser/Node.java $
 ...
 * {@link strutter.htmlparser.lexer.Lexer} or {@link Parser}, but each of the types
 * must support this interface.
 * More specific interface requirements for each of the node types are specified
 * by the {@link TextNode}, {@link RemarkNode} and {@link TagNode} interfaces.
 */
public interface Node extends Cloneable
{
	 ...
	 * {@link strutter.htmlparser.lexer.Lexer}.
	 * Currently, the object returned from this method can be safely cast to a
	 * {@link strutter.htmlparser.tags.CompositeTag}, but this behaviour should not
