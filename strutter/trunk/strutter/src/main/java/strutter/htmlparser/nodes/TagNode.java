...
//
// $URL: https://htmlparser.svn.sourceforge.net/svnroot/htmlparser/trunk/lexer/src/main/java/org/htmlparser/nodes/TagNode.java $
...
public class TagNode extends AbstractNode implements Tag
{
	 ...
	 */
	protected final static Scanner mDefaultScanner = new ScannerTag();
	 ...
	 */
	public TagNode(TagNode tag, ScannerTag scanner)
	{
	 ...
	 * by {@link strutter.htmlparser.tags.CompositeTag}, only renders the start tag.
